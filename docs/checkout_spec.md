...
### TC-CHECKOUT-S1-001 — Thêm địa chỉ mới thành công với dữ liệu hợp lệ
...
### TC-CHECKOUT-S1-002 — Báo lỗi khi bỏ trống một trường bắt buộc (EP)
...
### TC-CHECKOUT-S1-003 — Validate định dạng số điện thoại sai (EP)
...
### TC-CHECKOUT-S1-004 — Kiểm tra logic liên kết (Cascaded) của Dropdown địa lý
...
### TC-CHECKOUT-S1-005 — Cập nhật (Sửa) thông tin địa chỉ đã lưu
...
### TC-CHECKOUT-S2-003 — Kiểm tra áp dụng đồng thời Voucher và Freeship (Rule 1 - Decision Table)
...
### TC-CHECKOUT-S2-004 — Báo lỗi khi nhập Gift Card đã hết hạn/hết lượt sử dụng
...
### TC-CHECKOUT-S3-001 — Chuyển đổi trạng thái biểu mẫu Hóa đơn (State Transition)
...
### TC-CHECKOUT-S3-002 — Báo lỗi khi bỏ trống MST trong form Doanh nghiệp (EP)
...
### TC-CHECKOUT-S3-003 — Validate Email nhận hóa đơn sai định dạng (EP)
...
### TC-CHECKOUT-S3-004 — Luồng Happy Path xuất hóa đơn Cá nhân
...
### TC-CHECKOUT-S3-005 — Luồng Happy Path xuất hóa đơn Doanh nghiệp
